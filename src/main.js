...
function buildDock(ideWin) {
  ...
  dockItem(
    'Neon Void',
    `<div style="width:100%;height:100%;border-radius:13px;overflow:hidden;"><svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%;display:block;"><rect width="100" height="100" fill="#0d0520"/><circle cx="15" cy="18" r="1" fill="#fff" opacity=".7"/><circle cx="82" cy="11" r="1.5" fill="#fff" opacity=".5"/><circle cx="67" cy="30" r="1" fill="#fff" opacity=".6"/><circle cx="28" cy="72" r="1" fill="#fff" opacity=".4"/><circle cx="90" cy="65" r="1.5" fill="#fff" opacity=".6"/><circle cx="45" cy="85" r="1" fill="#fff" opacity=".4"/><g transform="translate(50,50)"><polygon points="0,-22 -10,10 0,4 10,10" fill="#00e5ff" opacity=".95"/><polygon points="-14,10 -20,18 -6,14" fill="#00b8d4" opacity=".8"/><polygon points="14,10 20,18 6,14" fill="#00b8d4" opacity=".8"/><ellipse cx="0" cy="14" rx="6" ry="3" fill="#00e5ff" opacity=".3"/><ellipse cx="0" cy="16" rx="4" ry="5" fill="#00e5ff" opacity=".15"/></g></svg></div>`,
    null,
...
const MOBILE_ICON_HTML = {
  ...
  'neon-void': `<div style="width:100%;height:100%;border-radius:inherit;"><svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%;display:block;"><rect width="100" height="100" fill="#0d0520"/><circle cx="15" cy="18" r="1" fill="#fff" opacity=".7"/><circle cx="82" cy="11" r="1.5" fill="#fff" opacity=".5"/><circle cx="67" cy="30" r="1" fill="#fff" opacity=".6"/><circle cx="28" cy="72" r="1" fill="#fff" opacity=".4"/><circle cx="90" cy="65" r="1.5" fill="#fff" opacity=".6"/><circle cx="45" cy="85" r="1" fill="#fff" opacity=".4"/><g transform="translate(50,50)"><polygon points="0,-22 -10,10 0,4 10,10" fill="#00e5ff" opacity=".95"/><polygon points="-14,10 -20,18 -6,14" fill="#00b8d4" opacity=".8"/><polygon points="14,10 20,18 6,14" fill="#00b8d4" opacity=".8"/><ellipse cx="0" cy="14" rx="6" ry="3" fill="#00e5ff" opacity=".3"/><ellipse cx="0" cy="16" rx="4" ry="5" fill="#00e5ff" opacity=".15"/></g></svg></div>`,
...
function buildDesktopIcons(ideWin) {
  const icons = [
    ...
    {
      label: 'Neon Void',
      iconHtml: `<div style="width:100%;height:100%;border-radius:12px;overflow:hidden;"><svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%;display:block;"><rect width="100" height="100" fill="#0d0520"/><circle cx="15" cy="18" r="1" fill="#fff" opacity=".7"/><circle cx="82" cy="11" r="1.5" fill="#fff" opacity=".5"/><circle cx="67" cy="30" r="1" fill="#fff" opacity=".6"/><circle cx="28" cy="72" r="1" fill="#fff" opacity=".4"/><circle cx="90" cy="65" r="1.5" fill="#fff" opacity=".6"/><circle cx="45" cy="85" r="1" fill="#fff" opacity=".4"/><g transform="translate(50,50)"><polygon points="0,-22 -10,10 0,4 10,10" fill="#00e5ff" opacity=".95"/><polygon points="-14,10 -20,18 -6,14" fill="#00b8d4" opacity=".8"/><polygon points="14,10 20,18 6,14" fill="#00b8d4" opacity=".8"/><ellipse cx="0" cy="14" rx="6" ry="3" fill="#00e5ff" opacity=".3"/><ellipse cx="0" cy="16" rx="4" ry="5" fill="#00e5ff" opacity=".15"/></g></svg></div>`,
